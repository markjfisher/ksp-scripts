  ...
  function burn_mean {
    ...
    until (wholeDV >= dv) {
      ...
      if deltV > 0 {
        ...
        local F is DV_rawDict[finalStage][3].
        local m_d is DV_rawDict[finalStage][4].
        local m_0 is DV_deltaVDict[finalStage][3].
        local t_1 is - (CONSTANT:E^(ln(m_0)-(deltV*m_d)/F)-m_0)/m_d.
        local t_m is (m_0*ln((m_d*t_1-m_0)/-m_0)+m_d*t_1)/(m_d*ln((m_0-m_d*t_1)/m_0)).
